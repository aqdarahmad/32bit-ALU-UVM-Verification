...
# history.py generated at 2026/01/08 13:50:46
# host: orionvtech
# port: 44809
# launch command: indago -connect dc:orionvtech.orionvtech.com:45875 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=44809,
        extra_args='-connect dc:orionvtech.orionvtech.com:45875 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 44809
# Verisium: **************************************************************************************
