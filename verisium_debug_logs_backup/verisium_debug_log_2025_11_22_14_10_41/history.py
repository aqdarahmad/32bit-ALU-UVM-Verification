...
# history.py generated at 2025/11/22 16:03:05
# host: orionvtech
# port: 46287
# launch command: indago -connect dc:orionvtech.orionvtech.com:34689 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=46287,
        extra_args='-connect dc:orionvtech.orionvtech.com:34689 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 46287
# Verisium: **************************************************************************************
