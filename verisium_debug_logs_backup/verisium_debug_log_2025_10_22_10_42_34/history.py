...
# history.py generated at 2025/10/22 13:35:22
# host: orionvtech
# port: 32815
# launch command: indago -connect dc:orionvtech.orionvtech.com:53889 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=32815,
        extra_args='-connect dc:orionvtech.orionvtech.com:53889 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 32815
# Verisium: **************************************************************************************
