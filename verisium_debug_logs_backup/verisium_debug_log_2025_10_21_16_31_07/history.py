...
# history.py generated at 2025/10/21 19:27:15
# host: orionvtech
# port: 40801
# launch command: indago -connect dc:orionvtech.orionvtech.com:37139 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=40801,
        extra_args='-connect dc:orionvtech.orionvtech.com:37139 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 40801
# Verisium: **************************************************************************************
