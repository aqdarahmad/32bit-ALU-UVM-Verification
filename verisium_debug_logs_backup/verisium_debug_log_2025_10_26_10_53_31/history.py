...
# history.py generated at 2025/10/26 12:53:31
# host: orionvtech
# port: 45935
# launch command: indago -connect dc:orionvtech.orionvtech.com:47659 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=45935,
        extra_args='-connect dc:orionvtech.orionvtech.com:47659 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 45935
# Verisium: **************************************************************************************
