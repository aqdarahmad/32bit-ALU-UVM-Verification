#########################################################################
# Verisium Debug version 24.09.002-s (Built on 2025-01-14T21:04:24Z)
# history.py generated at 2025/10/21 17:52:48
# host: orionvtech
# port: 45259
# launch command: indago -connect dc:orionvtech.orionvtech.com:46605 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=45259,
        extra_args='-connect dc:orionvtech.orionvtech.com:46605 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 45259
# Verisium: **************************************************************************************
# Verisium: *****                        Verisium version 24.09.002-s                        *****
