...
# history.py generated at 2025/10/21 18:05:22
# host: orionvtech
# port: 36177
# launch command: indago -connect dc:orionvtech.orionvtech.com:39057 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=36177,
        extra_args='-connect dc:orionvtech.orionvtech.com:39057 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 36177
# Verisium: **************************************************************************************
