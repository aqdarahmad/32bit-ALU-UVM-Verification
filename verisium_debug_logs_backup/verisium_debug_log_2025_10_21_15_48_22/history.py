...
# history.py generated at 2025/10/21 18:48:22
# host: orionvtech
# port: 45261
# launch command: indago -connect dc:orionvtech.orionvtech.com:37561 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=45261,
        extra_args='-connect dc:orionvtech.orionvtech.com:37561 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 45261
# Verisium: **************************************************************************************
