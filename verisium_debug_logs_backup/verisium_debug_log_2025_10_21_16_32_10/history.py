...
# history.py generated at 2025/10/21 19:31:38
# host: orionvtech
# port: 42491
# launch command: indago -connect dc:orionvtech.orionvtech.com:37177 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=42491,
        extra_args='-connect dc:orionvtech.orionvtech.com:37177 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 42491
# Verisium: **************************************************************************************
